...
<head>
    ...
    <title>Política de Privacidad - Padel Match</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="section">
        ...
        <div class="highlight-box">
            <p><strong>Nombre de la App:</strong> Padel Match</p>
    ...
    <div class="section">
        ...
        <p>Para ofrecerte una experiencia completa y conectar a jugadores de pádel, <strong>Padel Match</strong> recopila los siguientes tipos de datos:</p>
    ...
    <div class="footer">
        <p>
            &copy; 2026 <strong>Padel Match - TB Group</strong> — Todos los derechos reservados.
